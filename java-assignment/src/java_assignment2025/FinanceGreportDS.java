 ...
 * @author Isaac
 */
public class FinanceGreportDS extends javax.swing.JFrame {
    ...
    /**
     * Creates new form FinanceGreportDS
     */
    public FinanceGreportDS() {
        initComponents();
        jDateChooser1.setDate(new Date()); // set calendar to today
        currentFilter = FilterType.DATE;   // default filter is date
    ...
    for (DailySalesSummary summary : summaries) {
        model.addRow(new Object[]{
            ...
            summary.getItemName(),
            summary.getQuantity(),
            String.format("RM %.2f", summary.getTotalAmount()),
            summary.getDate()
        });
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1294, 723));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FinanceGreportDS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FinanceGreportDS().setVisible(true);
            }
        });
    }
